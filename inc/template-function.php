...
?>
    ...
    <a href="<?php echo home_url('/'); ?>"><img src="<?php echo esc_url($logo_url); ?>" alt="Main Logo"></a>
...
{
    $search_logo_url = get_theme_mod('search_logo_url', get_template_directory_uri() . '/assets/img/logo/logo-white.png');
?>

    <a href="<?php echo home_url('/'); ?>"><img src="<?php echo esc_url($search_logo_url); ?>" alt="search logo"></a>
